...
system("test -e pharo-core || git clone --depth=1 -b 4.0 --no-checkout #{REPOS}")
...
exec("$PHARO_VM Pharo-#{PHARO_VERSION}.image #{SCRIPTS}/scripts/pharo/pharo-4.0-git-tracker.st")
