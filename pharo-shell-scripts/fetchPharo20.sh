...
sh "$WORKSPACE/download.sh" "$WORKSPACE/images/Pharo20.zip" https://ci.lille.inria.fr/pharo/view/Pharo-Kernel%202.0/job/Pharo-2.0/lastSuccessfulBuild/artifact/Pharo-2.0.zip
